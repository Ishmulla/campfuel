...
<tr>
	...
	<td>CAD$ <?php echo $price; ?></td>
	<td><a target="targetframe" onclick="loadgif()" class="button is-success butt" href="confirm_fulfilment.php?order_id=<?php echo $order_id; ?>">CONFIRM</a> <a target="targetframe" onclick="loadgif()" class="button is-danger" href="decline_fulfilment.php?order_id=<?php echo $order_id; ?>&quantity=<?php echo $quantity; ?>&inventory_id=<?php echo $inventory_id; ?>">DECLINE</a></td>
</tr>
<?php
